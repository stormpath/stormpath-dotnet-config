...
namespace Stormpath.Configuration
{
    ...
    public sealed class ConfigurationLoader
    {
        ...
        private void BindClientSection(IConfigurationRoot compiled, ClientConfiguration client)
        {
            ...
            client.CacheManager.Caches = compiled.GetValue("stormpath:client:cacheManager:caches", new Dictionary<string, ClientCacheConfiguration>(Default.Configuration.Client.CacheManager.Caches));
        ...
        private void BindWebSection(IConfigurationRoot compiled, WebConfiguration web)
        {
            ...
            web.Expand = compiled.GetValue("stormpath:web:expand", Default.Configuration.Web.Expand);
            ...
            web.Produces = compiled.GetValue("stormpath:web:produces", Default.Configuration.Web.Produces);
