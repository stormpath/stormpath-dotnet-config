...
namespace Microsoft.Extensions.Configuration.Contrib.Stormpath.PropertiesFile
{
    ...
    {
        /// <summary>
        /// Adds the .properties configuration provider at <paramref name="path"/> to <paramref name="configurationBuilder"/>.
        /// </summary>
        ...
        public static IConfigurationBuilder AddPropertiesFile(this IConfigurationBuilder configurationBuilder, string path)
        {
